...
// Game class keeps track of the game, stores cells, units and players objects. It starts the game and makes turn transitions. 
...
public class Game : MonoBehaviour
{
    ...
    public List<SpaceShipUnits> Units { get; private set; }
    ...
    {
        CellGridState.OnUnitClicked(sender as SpaceShipUnits);
    }
    private void OnUnitDestroyed(object sender, AttackEventArgs e)
    {
        Units.Remove(sender as SpaceShipUnits);
