...
{
    private SpaceShipUnits _unit;
    private List<Cell> _pathsInRange;
    private List<SpaceShipUnits> _unitsInRange;

    private Cell _unitCell;

    public CellGridStateUnitSelected(Game cellGrid, SpaceShipUnits unit) : base(cellGrid)
    {
        _unit = unit;
        _pathsInRange = new List<Cell>();
        _unitsInRange = new List<SpaceShipUnits>();
    }
