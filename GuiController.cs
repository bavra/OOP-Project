...
public class GuiController : MonoBehaviour
{
    ...
    private void OnGameStarted(object sender, EventArgs e)
    {
        ...
        {
            unit.GetComponent<SpaceShipUnits>().UnitHighlighted += OnUnitHighlighted;
            unit.GetComponent<SpaceShipUnits>().UnitDehighlighted += OnUnitDehighlighted;
            unit.GetComponent<SpaceShipUnits>().UnitAttacked += OnUnitAttacked;
        }
    ...
    {
        InfoText.text = "Player " + ((sender as Game).CurrentPlayerNumber + 1) + " wins!";
    }
    private void OnTurnEnded(object sender, EventArgs e)
    {
        NextTurnButton.interactable = ((sender as Game).CurrentPlayer is HumanPlayer);

        InfoText.text = "Player " + ((sender as Game).CurrentPlayerNumber +1);
    }
    ...
    private void OnUnitAttacked(object sender, AttackEventArgs e)
    {
        ...
        if ((sender as SpaceShipUnits).HitPoints <= 0) return;
