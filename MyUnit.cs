...
public class MyUnit : SpaceShipUnits
{
    ...
    protected override void Defend(SpaceShipUnits other, int damage)
    {
    ...
    public override void MarkAsAttacking(SpaceShipUnits other)
    {
        StartCoroutine(Jerk(other));
    }
    public override void MarkAsDefending(SpaceShipUnits other)
    {
    ...
    private IEnumerator Jerk(SpaceShipUnits other)
    {
